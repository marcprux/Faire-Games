...
private val canonicalSolution: Array<Int> = arrayOf(
    5,
    3,
    4,
    6,
...
private fun generateSolution(): Array<Int> {
...
internal class SudokuModel: Observable {
    ...
    companion object {
        ...
        internal fun loadSavedState(): SudokuSavedState? {
            ...
            return try { JSONDecoder().decode(SudokuSavedState::class, from = data_1) } catch (_: Throwable) { null }
        }
