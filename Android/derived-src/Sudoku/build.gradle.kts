...
android {
    namespace = if ("org.appfair.app.fairegames.games.sudoku" == rootProject.name) "org.appfair.app.fairegames.games.sudoku.module" else "org.appfair.app.fairegames.games.sudoku"
}