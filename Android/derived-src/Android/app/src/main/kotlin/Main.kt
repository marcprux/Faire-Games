...
internal val logger: SkipLogger = SkipLogger(subsystem = "faire.games", category = "FaireGames")

private typealias AppRootView = FaireGamesRootView
private typealias AppDelegate = FaireGamesAppDelegate
