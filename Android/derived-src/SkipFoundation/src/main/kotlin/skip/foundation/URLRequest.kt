...
class URLRequest: MutableStruct {
    ...
    enum class Attribution(override val rawValue: Int, @Suppress("UNUSED_PARAMETER") unusedp: Nothing? = null): RawRepresentable<Int> {
        ...
        companion object {
            fun init(rawValue: Int): URLRequest.Attribution? {
    ...
    enum class CachePolicy(override val rawValue: Int, @Suppress("UNUSED_PARAMETER") unusedp: Nothing? = null): RawRepresentable<Int> {
        ...
        @androidx.annotation.Keep
        companion object {
            fun init(rawValue: Int): URLRequest.CachePolicy? {
                return when (rawValue) {
    ...
    enum class NetworkServiceType(override val rawValue: Int, @Suppress("UNUSED_PARAMETER") unusedp: Nothing? = null): RawRepresentable<Int> {
        ...
        @androidx.annotation.Keep
        companion object {
            fun init(rawValue: Int): URLRequest.NetworkServiceType? {
                return when (rawValue) {
    ...
    companion object {
        ...
        fun Attribution(rawValue: Int): URLRequest.Attribution? = Attribution.init(rawValue = rawValue)

        fun CachePolicy(rawValue: Int): URLRequest.CachePolicy? = CachePolicy.init(rawValue = rawValue)

        fun NetworkServiceType(rawValue: Int): URLRequest.NetworkServiceType? = NetworkServiceType.init(rawValue = rawValue)
    }
}
