...
open class OperationQueue {
    ...
    internal val runBlock: (() -> Unit) -> Unit

    constructor() {
        val executorService = Executors.newSingleThreadExecutor()
        this.runBlock = { block -> executorService.submit(block) }
    }

    constructor(runBlock: (() -> Unit) -> Unit) {
    ...
    companion object: CompanionClass() {
        ...
        override val main = OperationQueue(runBlock = { block ->
...
open class Operation {
    ...
    enum class QueuePriority(override val rawValue: Int, @Suppress("UNUSED_PARAMETER") unusedp: Nothing? = null): RawRepresentable<Int> {
        ...
        @androidx.annotation.Keep
        companion object {
            fun init(rawValue: Int): Operation.QueuePriority? {
    ...
    companion object: CompanionClass() {
        ...
        override fun QueuePriority(rawValue: Int): Operation.QueuePriority? = QueuePriority.init(rawValue = rawValue)
    }
    open class CompanionClass {
...
enum class QualityOfService(override val rawValue: Int, @Suppress("UNUSED_PARAMETER") unusedp: Nothing? = null): RawRepresentable<Int> {
    ...
    @androidx.annotation.Keep
    companion object {
        fun init(rawValue: Int): QualityOfService? {
            return when (rawValue) {
...
fun QualityOfService(rawValue: Int): QualityOfService? = QualityOfService.init(rawValue = rawValue)
