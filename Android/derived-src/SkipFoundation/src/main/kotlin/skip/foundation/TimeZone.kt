...
class TimeZone: Codable, KotlinConverting<java.util.TimeZone>, MutableStruct {
    ...
    enum class NameStyle(override val rawValue: Int, @Suppress("UNUSED_PARAMETER") unusedp: Nothing? = null): RawRepresentable<Int> {
        ...
        @androidx.annotation.Keep
        companion object {
            fun init(rawValue: Int): TimeZone.NameStyle? {
    ...
    companion object: DecodableCompanion<TimeZone> {
        ...
        fun NameStyle(rawValue: Int): TimeZone.NameStyle? = NameStyle.init(rawValue = rawValue)
    }
}
