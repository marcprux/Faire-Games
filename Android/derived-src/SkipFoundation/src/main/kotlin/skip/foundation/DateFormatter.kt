...
open class DateFormatter: Formatter {
    ...
    enum class Style(override val rawValue: UInt, @Suppress("UNUSED_PARAMETER") unusedp: Nothing? = null): RawRepresentable<UInt> {
        ...
        companion object {
            fun init(rawValue: UInt): DateFormatter.Style? {
    ...
    enum class Behavior(override val rawValue: Int, @Suppress("UNUSED_PARAMETER") unusedp: Nothing? = null): RawRepresentable<Int> {
        ...
        @androidx.annotation.Keep
        companion object {
            fun init(rawValue: Int): DateFormatter.Behavior? {
                return when (rawValue) {
                    0 -> Behavior.default
    ...
    companion object: CompanionClass() {
        ...
        override fun Style(rawValue: UInt): DateFormatter.Style? = Style.init(rawValue = rawValue)

        override fun Behavior(rawValue: Int): DateFormatter.Behavior? = Behavior.init(rawValue = rawValue)
    }
