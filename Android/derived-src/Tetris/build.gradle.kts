// build.gradle.kts generated by Skip for Tetris
...
android {
    namespace = if ("org.appfair.app.fairegames.games.tetris" == rootProject.name) "org.appfair.app.fairegames.games.tetris.module" else "org.appfair.app.fairegames.games.tetris"
}