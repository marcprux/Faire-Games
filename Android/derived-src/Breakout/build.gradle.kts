// build.gradle.kts generated by Skip for Breakout
...
android {
    namespace = if ("org.appfair.app.fairegames.games.breakout" == rootProject.name) "org.appfair.app.fairegames.games.breakout.module" else "org.appfair.app.fairegames.games.breakout"
}