// build.gradle.kts generated by Skip for Drop7
...
android {
    namespace = if ("org.appfair.app.fairegames.games.drop7" == rootProject.name) "org.appfair.app.fairegames.games.drop7.module" else "org.appfair.app.fairegames.games.drop7"
}