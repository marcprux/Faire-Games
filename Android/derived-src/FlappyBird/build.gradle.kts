// build.gradle.kts generated by Skip for FlappyBird
...
android {
    namespace = if ("org.appfair.app.fairegames.games.flappybird" == rootProject.name) "org.appfair.app.fairegames.games.flappybird.module" else "org.appfair.app.fairegames.games.flappybird"
}