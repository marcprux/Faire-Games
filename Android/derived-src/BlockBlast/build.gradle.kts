// build.gradle.kts generated by Skip for BlockBlast
...
android {
    namespace = if ("org.appfair.app.fairegames.games.blockblast" == rootProject.name) "org.appfair.app.fairegames.games.blockblast.module" else "org.appfair.app.fairegames.games.blockblast"
}