// build.gradle.kts generated by Skip for FaireGamesModel
...
android {
    namespace = if ("org.appfair.app.fairegames.gamemodel" == rootProject.name) "org.appfair.app.fairegames.gamemodel.module" else "org.appfair.app.fairegames.gamemodel"
}