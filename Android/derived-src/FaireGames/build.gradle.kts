// build.gradle.kts generated by Skip for FaireGames
...
dependencies {
    ...
    api(project(":SkipKit"))
    api(project(":SkipUI"))
    api(project(":BlockBlast"))
    api(project(":AppFairUI"))
    api(project(":Tetris"))
    api(project(":FlappyBird"))
    api(project(":Breakout"))
    api(project(":Sudoku"))
    api(project(":TwentyFortyEight"))
    api(project(":Drop7"))
}
...
android {
    namespace = if ("org.appfair.app.fairegames.ui" == rootProject.name) "org.appfair.app.fairegames.ui.module" else "org.appfair.app.fairegames.ui"
}