...
class SafeAreaRegions: OptionSet<SafeAreaRegions, Int>, MutableStruct {
...
internal class SafeArea {
    ...
    internal val description: String
        get() = "SafeArea(presentationBoundsPx: ${presentationBoundsPx}, safeBoundsPx: ${safeBoundsPx}, absoluteSystemBarEdges: ${absoluteSystemBarEdges})"
