...
class Picker<SelectionValue>: View, Renderable, skip.lib.SwiftProjecting {
    ...
    private var selectionTrigger: MutableState<Int>? = null
        get() = field.sref({ this.selectionTrigger = it })
        set(newValue) {
            field = newValue.sref()
        }
    ...
    private fun noteSelectionChanged() {
        selectionTrigger.sref()?.let { selectionTrigger ->
