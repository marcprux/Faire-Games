...
open class UIImage: skip.lib.SwiftProjecting {
    ...
    constructor(contentsOfFile: String) {
        ...
        try {
            ...
            val bitmap_0 = Companion.decodeBitmapFromUri(contentResolver = contentResolver, uri = uri)
            if (bitmap_0 == null) {
    ...
    constructor(data: Data, scale: Double = 1.0) {
        try {
            ...
            val bitmap_1 = Companion.decodeBitmapFromData(bytes = bytes)
            if (bitmap_1 == null) {
                throw NullReturnException()
            }
    ...
    companion object: CompanionClass() {
        ...
        private fun decodeBitmapFromData(bytes: kotlin.ByteArray): Bitmap? {
        ...
        private fun decodeBitmapFromUri(contentResolver: ContentResolver, uri: Uri): Bitmap? {
            ...
            return contentResolver.openInputStream(uri)?.use { stream -> BitmapFactory.decodeStream(stream) }
        }
