...
class GridItem: MutableStruct, skip.lib.SwiftProjecting {
    @androidx.annotation.Keep
    sealed class Size: skip.lib.SwiftProjecting {
    ...
    constructor(size: GridItem.Size, spacing: Double?, horizontalAlignmentKey: String?, verticalAlignmentKey: String?) {
        this.size = size
        this.spacing = spacing
        if ((horizontalAlignmentKey != null) && (verticalAlignmentKey != null)) {
