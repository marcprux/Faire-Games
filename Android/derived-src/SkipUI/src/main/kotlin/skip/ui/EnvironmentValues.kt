...
class EnvironmentValues {
    ...
    private fun builtinBridged(key: String): EnvironmentSupport? {
        ...
        when (key) {
            "accessibilityEnabled" -> return EnvironmentSupport(builtinValue = AccessibilityEnvironment.shared.accessibilityEnabled())
            "accessibilityInvertColors" -> return EnvironmentSupport(builtinValue = AccessibilityEnvironment.shared.accessibilityInvertColors())
            "accessibilityReduceMotion" -> return EnvironmentSupport(builtinValue = AccessibilityEnvironment.shared.accessibilityReduceMotion())
            "accessibilityReduceTransparency" -> return EnvironmentSupport(builtinValue = AccessibilityEnvironment.shared.accessibilityReduceTransparency())
            "accessibilitySwitchControlEnabled" -> return EnvironmentSupport(builtinValue = AccessibilityEnvironment.shared.accessibilitySwitchControlEnabled())
            "accessibilityVoiceOverEnabled" -> return EnvironmentSupport(builtinValue = AccessibilityEnvironment.shared.accessibilityVoiceOverEnabled())
            "colorSchemeContrast" -> return EnvironmentSupport(builtinValue = AccessibilityEnvironment.shared.colorSchemeContrast().rawValue)
            ...
            "legibilityWeight" -> return EnvironmentSupport(builtinValue = legibilityWeight)
    ...
    private fun setBuiltinBridged(key: String, value: EnvironmentSupport?): Boolean {
        when (key) {
            "accessibilityEnabled" -> return false
            "accessibilityInvertColors" -> return false
            "accessibilityReduceMotion" -> return false
            "accessibilityReduceTransparency" -> return false
            "accessibilitySwitchControlEnabled" -> return false
            "accessibilityVoiceOverEnabled" -> return false
            "colorSchemeContrast" -> return false
    ...
    open val accessibilityEnabled: Boolean
        @Composable
        get() = AccessibilityEnvironment.shared.accessibilityEnabled()

    open val accessibilityInvertColors: Boolean
        @Composable
        get() = AccessibilityEnvironment.shared.accessibilityInvertColors()

    open val accessibilityReduceMotion: Boolean
        @Composable
        get() = AccessibilityEnvironment.shared.accessibilityReduceMotion()

    open val accessibilityReduceTransparency: Boolean
        @Composable
        get() = AccessibilityEnvironment.shared.accessibilityReduceTransparency()

    open val accessibilitySwitchControlEnabled: Boolean
        @Composable
        get() = AccessibilityEnvironment.shared.accessibilitySwitchControlEnabled()

    open val accessibilityVoiceOverEnabled: Boolean
        @Composable
        get() = AccessibilityEnvironment.shared.accessibilityVoiceOverEnabled()

    open val colorSchemeContrast: ColorSchemeContrast
        @Composable
        get() = AccessibilityEnvironment.shared.colorSchemeContrast()

    open val legibilityWeight: LegibilityWeight?
        @Composable
        get() {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                val adjustment = LocalConfiguration.current.fontWeightAdjustment.sref()
                if (adjustment == Configuration.FONT_WEIGHT_ADJUSTMENT_UNDEFINED) {
                    return null
                }
                return if (adjustment == 0) LegibilityWeight.regular else LegibilityWeight.bold
            }
            return null
        }
    ...
    */
    ...
    internal open val _textFieldContentPadding: EdgeInsets?
        @Composable
        get() {
            return (builtinValue(key = "_textFieldContentPadding", defaultValue = { -> null }) as EdgeInsets?).sref()
        }
    internal fun set_textFieldContentPadding(newValue: EdgeInsets?) {
        setBuiltinValue(key = "_textFieldContentPadding", value = newValue, defaultValue = { -> null })
    }
    ...
    internal open val _listRowSpacing: Double?
        @Composable
        get() {
            return builtinValue(key = "_listRowSpacing", defaultValue = { -> null }) as Double?
        }
    internal fun set_listRowSpacing(newValue: Double?) {
        setBuiltinValue(key = "_listRowSpacing", value = newValue, defaultValue = { -> null })
    }
    ...
    internal open val _navigationStackTransitions: ((NavDisplayTransitionOptions) -> NavDisplayTransitionOptions)?
        @Composable
        get() {
            return builtinValue(key = "_navigationStackTransitions", defaultValue = { -> null }) as ((NavDisplayTransitionOptions) -> NavDisplayTransitionOptions)?
        }
    internal fun set_navigationStackTransitions(newValue: ((NavDisplayTransitionOptions) -> NavDisplayTransitionOptions)?) {
        setBuiltinValue(key = "_navigationStackTransitions", value = newValue, defaultValue = { -> null })
    }
    ...
    internal open val _tabViewTransitions: ((NavDisplayTransitionOptions) -> NavDisplayTransitionOptions)?
        @Composable
        get() {
            return builtinValue(key = "_tabViewTransitions", defaultValue = { -> null }) as ((NavDisplayTransitionOptions) -> NavDisplayTransitionOptions)?
        }
    internal fun set_tabViewTransitions(newValue: ((NavDisplayTransitionOptions) -> NavDisplayTransitionOptions)?) {
        setBuiltinValue(key = "_tabViewTransitions", value = newValue, defaultValue = { -> null })
    }
    ...
    internal open val _subcomposeAsyncImage: Boolean
        @Composable
        get() {
            return builtinValue(key = "_subcomposeAsyncImage", defaultValue = { -> false }) as Boolean
        }
    internal fun set_subcomposeAsyncImage(newValue: Boolean) {
        setBuiltinValue(key = "_subcomposeAsyncImage", value = newValue, defaultValue = { -> false })
    }
