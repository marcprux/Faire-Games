...
enum class LayoutDirection(override val rawValue: Int, @Suppress("UNUSED_PARAMETER") unusedp: Nothing? = null): CaseIterable, RawRepresentable<Int> {
    leftToRight(0), // For bridging
    rightToLeft(1); // For bridging

    @androidx.annotation.Keep
    companion object: CaseIterableCompanion<LayoutDirection> {
        fun init(rawValue: Int): LayoutDirection? {
...
fun LayoutDirection(rawValue: Int): LayoutDirection? = LayoutDirection.init(rawValue = rawValue)

sealed class LayoutDirectionBehavior {
